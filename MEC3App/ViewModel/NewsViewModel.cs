    ...
    class NewsViewModel : BaseViewModel
    {
        ...
        public ObservableCollection<NewsModel> GetNewsList()
        {
            ...
            foreach (var result in model.Data)
            {
                ...
                {
                    subPerex = description.Substring(0, 100) + "...";
                }
                else
                {
                    subPerex = description;
                }

                subName = name.Replace("&reg;", " ").Replace("&nbsp;", " ").Replace("<br />", " ").Replace(";", ""); 
                NewsList.Add(new NewsModel(subName, image, id, subPerex, content));
